...
export const card: CardDef = {
  ...
  schema: [
    ...
    { type: "number", key: "tx", label: "目标 x（舞台坐标，960 基准）", default: 328, min: 0, max: 960, step: 1, unit: "px" },
    { type: "number", key: "ty", label: "目标 y", default: 236, min: 0, max: 540, step: 1, unit: "px" },
    { type: "number", key: "tw", label: "目标宽", default: 216, min: 20, max: 960, step: 1, unit: "px" },
