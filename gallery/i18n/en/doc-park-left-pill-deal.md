...
- Source card: video-shotcraft `doc-park-left-pill-deal` (document parked to 35% + slow pill deal + subtitle deepening word by word). Voiceover adaptation: subtitles become explanatory lines that stay once landed; the document is read full-frame for 0.9s before parking.
