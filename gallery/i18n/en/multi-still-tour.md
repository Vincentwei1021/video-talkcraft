...
- Not this card: the demo's sample photos (demo context, `demos/_lib/media`, not part of the card), the "case one–three" and "2019–2026" copy, the layout-name tag (tour only), the line colour (#1d1d1f, changeable), exact card radius / shadow values, the exact wall backdrop colours.
